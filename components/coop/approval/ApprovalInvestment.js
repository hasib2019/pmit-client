...
const ApprovalInvestment = (props) => {
  ...
  return (
    <>
      <Grid item xs={12} className="approve-info">
        <Grid container>
          ...
          <Grid container>
            <Grid item md={6} xs={12}>
              <div className="info">
                <span className="label">বিনিয়োগের জন্য আবেদন :&nbsp;</span>{' '}
                {applyDates && numberToWord('' + applyDates + '')}
              </div>
            </Grid>
            <Grid item md={6} xs={12}>
              <div className="info">
                <span className="label">বিনিয়োগের কারণ :&nbsp;</span>{' '}
                <span
      ...
      <Grid container className="section">
        <Grid item xs={12}>
          <SubHeading>বিনিয়োগের ডকুমেন্ট</SubHeading>
          <Grid container>
...
export default ApprovalInvestment;
