...
const ApprovalManualSamity = (props) => {
  ...
  console.log({ date: samityInfo.samityRegistrationDate })
  return (
    <>
      <Grid
        item
        ...
        <Grid container spacing={2.5}>
          ...
          <Grid item md={6} xs={12} sx={{ paddingTop: { xs: '0 !important', md: '12px !important' } }}>
            ...
            <div className="info">
              ...
              {samityInfo.samityFormationDate && numberToWord('' + samityInfo?.samityFormationDate + '')}
            </div>
            <div className="info">
...
export default ApprovalManualSamity;
