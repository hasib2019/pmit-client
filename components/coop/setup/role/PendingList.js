        ...
        <Grid item xxl={12} xl={12} lg={12} md={12} sm={12} xs={12}>
          <TableContainer className="table-container">
            <Table size="small" aria-label="a dense table">
              <TableHead className="table-head">
                <TableRow>
                  <TableCell className="table-data-center" sx={{ width: '5%', minWidth: '60px' }}>
                    ক্রমিক নং
                  </TableCell>
                  <TableCell>রোলের নাম</TableCell>
                  <TableCell>বর্ননা</TableCell>
                  <TableCell>অবস্থান </TableCell>
                  <TableCell className="table-data-center">সম্পাদন</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {listRole.map((data, i) => (
                  <TableRow key={i} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                    <TableCell component="th" scope="row" className="table-data-center">
                      {i + 1}
                    </TableCell>
                    ...
                    <TableCell className="table-data-center" sx={{ display: 'flex', justifyContent: 'center' }}>
                      <div style={{ display: 'flex' }}>
                        <Avatar sx={{ marginRight: '5px', backgroundColor: 'transparent' }}>
          ...
          >
            <Box className={style.modalStyle}>
              <h2 id="parent-modal-title" style={{ textAlign: 'center', fontSize: '30px', fontWeight: 'bold' }}>
                {' '}
                ফিচার লিস্ট
              </h2>
              ...
              <HighlightOffIcon
                sx={{ fontSize: '30px', position: 'absolute', top: '0', right: '0', cursor: 'pointer' }}
                onClick={handleClose}
              />
            </Box>
          </Modal>
