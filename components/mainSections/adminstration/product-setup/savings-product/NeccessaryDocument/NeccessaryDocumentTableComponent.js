...
const NeccessaryDocumentTableComponent = ({ data, editDataFunc }) => {
  return (
    <>
      {data?.length >= 1 && (
          ...
          <TableContainer className="table-container">
            <Table aria-label="customized table" size="small">
              <TableHead className="table-head">
                <TableRow>
                  <TableCell align="center">ডকুমেন্টের ধরণ</TableCell>
                  <TableCell align="center">বাধ্যতামূলক?</TableCell>
...
export default NeccessaryDocumentTableComponent;
