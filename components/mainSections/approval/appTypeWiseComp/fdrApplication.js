        ...
        <Grid item md={12} sm={12} xs={12}>
          {/* <TableContainer className="table-container">
              <Table size="small" aria-label="a dense table">
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="table-data-right">{applicationInfo.installmentAmount ? engToBang(applicationInfo.installmentAmount ): " "}</TableCell>
                    <TableCell className="table-data-center">{applicationInfo.time ? engToBang(applicationInfo.time) : " "}</TableCell>
          ...
          <TableContainer className="table-container">
            <Table size="small" aria-label="a dense table">
              <TableHead className="table-head">
                <TableRow>
                  <TableCell align="right">এফডিআর এর পরিমাণ</TableCell>
                  <TableCell align="center">এফডিআর ক্লোজের তারিখ</TableCell>
                  <TableCell align="right">মুনাফার পরিমাণ (টাকা)</TableCell>
                  <TableCell align="right">মুনাফার হার (%)</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                <TableRow>
                  <TableCell align="right">
                    {applicationInfo.fdrAmount ? engToBang(applicationInfo.fdrAmount) : ' '}
                  </TableCell>
                  <TableCell align="center">
                    {applicationInfo.expDate ? engToBang(applicationInfo.expDate) : ''}
                  </TableCell>
                  <TableCell align="right">
       ...
       <SubHeading>ডকুমেন্টের তথ্য</SubHeading>
        ...
        <TableContainer className="table-container">
            <Table size="small" aria-label="a dense table">
              ...
              <TableBody>
                {applicationInfo?applicationInfo.documentInfo?.map((v, i) => (
                  <TableRow key={i}>
