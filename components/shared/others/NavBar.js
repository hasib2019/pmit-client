  ...
  return (
    <Box>
      <AppBar className={`${classes.navBar}`} sx={{ backgroundColor: updatedColor }}>
        <Toolbar>
          <IconButton size="large" edge="start" color="inherit" aria-label="menu" onClick={controlDrawer}>
            <MenuIcon />
          </IconButton>
          ...
          <div>
            <Tooltip title="Settings">
              <IconButton onClick={handleClick}>
                <Chip style={{ cursor: 'pointer' }} avatar={<Avatar alt="gov" src="/govt1.png" />} color="primary" />
              </IconButton>
            </Tooltip>
